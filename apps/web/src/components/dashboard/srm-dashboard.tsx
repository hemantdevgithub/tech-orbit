    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <WorkspaceCard icon={<UsersIcon size={18} />} title="Submissions" subtitle="Candidates in flight" href="/requirements" />
          <WorkspaceCard icon={<TargetIcon size={18} />} title="Pipeline" subtitle="Status & tracking" href="/requirements" />
          <WorkspaceCard icon={<HandshakeIcon size={18} />} title="Placements" subtitle="Closed deals" href="/placements" />
      ...
      {!loading && (
        <StatStrip
          ...
          stats={[
            { label: "Active submissions", value: active, href: "/requirements" },
            { label: "Placements closed", value: placed, href: "/placements" },
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/requirements" className="text-xs text-forest-700 hover:underline">Find requirements →</Link>
        </div>
        <div className="bg-white rounded-xl border border-sage-200 divide-y divide-sage-100">
          {loading ? (
            ...
            <div className="px-5 py-8 text-center">
              ...
              <Link href="/requirements" className="text-xs text-forest-700 hover:underline">Browse requirements to submit to →</Link>
            </div>
          ) : (
            recent.map((s) => (
