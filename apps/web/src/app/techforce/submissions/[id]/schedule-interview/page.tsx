...
export default function ScheduleInterviewPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/techforce/interviews/${iv.id}?just_scheduled=1`);
    } catch (err) {
            ...
            {interviewType === "PLATFORM" && (
              <div>
                ...
                <p className="mt-1 text-xs text-sage-600">
                  Browse <Link href="/techforce/interviewers" className="text-forest-700 hover:underline">the interviewer marketplace</Link> to find a UUID.
