    ...
    <div>
      <Breadcrumbs
        items={[
          ...
          { label: "Interviews", href: "/techforce/interviews" },
        ...
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <span className="text-sage-600 text-sm">
              ...
              {" · "}
              <Link
                href={`/techforce/submissions/${iv.submissionId}`}
          ...
          <Card>
            ...
            <CardBody>
              <dl className="grid grid-cols-2 gap-y-3 text-sm">
                ...
                <dd>
                  <Link
                    href={`/techforce/candidates/${iv.candidateId}`}
                    className="text-forest-700 hover:underline"
                  >
                    {candidateName}
                  </Link>
                ...
                <dd>
                  {iv.interviewerUserId ? (
                    <Link
                      href={`/techforce/interviewers/${iv.interviewerUserId}`}
                      className="text-forest-700 hover:underline"
                    >
                      {interviewerName}
                    </Link>
        ...
        <div className="space-y-3">
          {canJoin && (
            <Card>
              ...
              <CardBody>
                <Link href={`/techforce/interviews/${iv.id}/call`} className="block">
          ...
          {canScorecard && (
            <Card>
              ...
              <CardBody>
                <Link href={`/techforce/interviews/${iv.id}/scorecard`} className="block">
