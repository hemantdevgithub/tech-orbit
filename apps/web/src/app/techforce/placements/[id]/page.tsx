    ...
    <div>
      <Breadcrumbs
        items={[
          ...
          { label: "Placements", href: "/techforce/placements" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardBody className="space-y-1.5 text-sm">
              <Link href={`/techforce/requirements/${placement.requirementId}`} className="block text-forest-700 hover:underline">
                View requirement →
              </Link>
              <Link href={`/techforce/submissions/${placement.submissionId}`} className="block text-forest-700 hover:underline">
                View submission →
              </Link>
            </CardBody>
          </Card>
            ...
            (user?.id === placement.createdByUserId || user?.id === placement.candidateId) && (
              <Card>
                ...
                <CardBody className="text-sm space-y-2">
                  ...
                  <Link
                    href={`/techforce/placements/${placement.id}/rate`}
