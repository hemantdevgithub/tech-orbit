...
export default function RoleApplicationDetailPage() {
  ...
  async function onApprove() {
    ...
    try {
      ...
      router.push("/admin/role-applications?approved=1");
    } catch (err) {
  ...
  async function onReject() {
    ...
    try {
      ...
      router.push("/admin/role-applications?rejected=1");
    } catch (err) {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <Link href="/admin/role-applications" className="text-sm text-forest-700 hover:underline">
          ← All applications
        </Link>
