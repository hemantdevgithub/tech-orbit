...
const ROLES: Array<ApplicationRole | "ALL"> = ["ALL", "CRM", "SRM", "MSME", "INTERVIEWER"];
                ...
                {rows.map((r) => (
                  <tr key={r.id} className="border-b border-surface-border/50 last:border-0 hover:bg-cream-50">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link href={`/admin/role-applications/${r.id}`} className="text-forest-700 hover:underline text-xs font-semibold">
                        Review →
                      </Link>
                    </td>
                  </tr>
