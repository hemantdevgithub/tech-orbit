    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard
          ...
          href="/admin/role-applications?status=PENDING"
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between gap-2">
              ...
              <Link href="/admin/role-applications" className="text-xs text-forest-700 hover:underline">View all →</Link>
            </div>
          </CardHeader>
            ...
            {pendingApps.length === 0 ? (
              ...
              <ul className="divide-y divide-surface-border/50">
                {pendingApps.map((a) => (
                  <li key={a.id}>
                    <Link
                      href={`/admin/role-applications/${a.id}`}
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between gap-2">
              ...
              <Link href="/admin/disputes" className="text-xs text-forest-700 hover:underline">View all →</Link>
            </div>
          </CardHeader>
          <CardBody className="p-0">
      ...
      <Card>
        ...
        <CardBody className="flex flex-wrap gap-3 text-sm">
          <Link href="/admin/users" className="px-4 py-2 rounded-lg bg-surface-elevated border border-surface-border hover:border-forest-300 font-medium text-forest-900">
            Search users
          </Link>
          <Link href="/admin/audit-logs" className="px-4 py-2 rounded-lg bg-surface-elevated border border-surface-border hover:border-forest-300 font-medium text-forest-900">
            Audit logs
          </Link>
          <Link href="/admin/disputes?status=OPEN" className="px-4 py-2 rounded-lg bg-surface-elevated border border-surface-border hover:border-forest-300 font-medium text-forest-900">
            Open disputes
          </Link>
        </CardBody>
      </Card>
