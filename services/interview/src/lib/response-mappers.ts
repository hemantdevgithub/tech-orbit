...
export function toInterviewResponse(iv: Interview): InterviewResponse {
  return {
    ...
    videoRecordingStatus: iv.videoRecordingStatus,
    videoRecordingStartedAt: iv.videoRecordingStartedAt?.toISOString() ?? null,
    videoRecordingEndedAt: iv.videoRecordingEndedAt?.toISOString() ?? null,
    videoRecordingDurationSec: iv.videoRecordingDurationSec,
    status: iv.status,
